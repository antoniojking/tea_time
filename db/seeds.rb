...
#Flavors
Flavor.create(package_id: 1, tea_id: 4)
Flavor.create(package_id: 1, tea_id: 5)
Flavor.create(package_id: 1, tea_id: 6)
Flavor.create(package_id: 2, tea_id: 1)
Flavor.create(package_id: 2, tea_id: 2)
Flavor.create(package_id: 2, tea_id: 3)
Flavor.create(package_id: 3, tea_id: 5)
Flavor.create(package_id: 3, tea_id: 8)
Flavor.create(package_id: 3, tea_id: 10)
Flavor.create(package_id: 4, tea_id: 1)
Flavor.create(package_id: 4, tea_id: 7)
Flavor.create(package_id: 4, tea_id: 9)
